...
class RemoveDuplicatesCollectionsTest {
    @Test
    @DisplayName("Should return empty array when null")
    void shouldReturnEmptyArrayWhenNull() {
        String[] args = null;
        String[] actual = RemoveDuplicatesCollections.removeDuplicates(args);
    ...
    void shouldReturnUniqueValuesArray() {
        ...
        String[] actual = RemoveDuplicatesCollections.removeDuplicates(few_strings);
        assertAll(
    ...
    void shouldRemoveDuplicatesForHugeString() {
        ...
        String[] actual = RemoveDuplicatesCollections.removeDuplicates(many_strings);
